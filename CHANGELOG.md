...
- Add Apache Commons Lang 3 StringUtils for null checking of strings
- ProductCategoriesPredicateJpaServiceImpl - refactor switch case snippet to command pattern since sonar tag as cyclomatic issue
