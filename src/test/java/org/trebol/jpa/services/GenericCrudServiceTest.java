...
class GenericCrudServiceTest {
  ...
  @Mock ITwoWayConverterService<GenericPojo, GenericEntity> genericConverterMock;
  @Mock IDataTransportService<GenericPojo, GenericEntity> genericDataTransportServiceMock;
  ...
  @Test
  void sanity_checks() {
    GenericCrudService<GenericPojo, GenericEntity> service = this.instantiate_without_existing_entity();
    assertNotNull(service);

    GenericCrudService<GenericPojo, GenericEntity> service2 = this.instantiate_with_existing_entity();
  ...
  void reads_plural_data_with_items() {
    ...
    when(genericConverterMock.convertToPojo(persistedEntity)).thenReturn(persistedPojo);
    GenericCrudService<GenericPojo, GenericEntity> service = this.instantiate_with_existing_entity();
  ...
  private GenericCrudService<GenericPojo, GenericEntity> instantiate_without_existing_entity() {
  ...
  private GenericCrudService<GenericPojo, GenericEntity> instantiate_with_existing_entity() {
    return new GenericCrudService<>(
      genericRepositoryMock,
      genericConverterMock,
      genericDataTransportServiceMock) {
