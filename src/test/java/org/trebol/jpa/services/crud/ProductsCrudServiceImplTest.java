...
class ProductsCrudServiceImplTest {
  ...
  @Mock IProductsConverterService productsConverterMock;
  ...
  @Mock IProductCategoriesConverterService categoriesConverterMock;
  @Mock IImagesConverterService imagesConverterMock;
