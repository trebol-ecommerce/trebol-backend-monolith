...
public class ProductsJpaCrudServiceImpl
  ...
  /**
   * Forcefully saves a product's relationship to a category.
   * Here 'forcefully' means that it will always try to create the category, and if it fails, to fetch it.
