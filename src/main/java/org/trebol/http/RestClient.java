...
public class RestClient {
  ...
  public String get(String uri) throws RestClientException {
  ...
  public void put(String uri, String json) throws RestClientException {
    HttpEntity<String> requestEntity = new HttpEntity<>(json, headers);
    ResponseEntity<String> responseEntity = rest.exchange(server + uri, HttpMethod.PUT, requestEntity, String.class);
    this.setStatus(responseEntity.getStatusCode());
  }

  public void delete(String uri) throws RestClientException {
    HttpEntity<String> requestEntity = new HttpEntity<>("", headers);
