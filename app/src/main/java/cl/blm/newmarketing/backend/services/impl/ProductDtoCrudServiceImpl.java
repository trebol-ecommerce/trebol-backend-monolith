...
@Transactional
@Service
public class ProductDtoCrudServiceImpl
    implements DtoCrudService<ProductDto, Integer> {
  private static final Logger LOG = LoggerFactory.getLogger(ProductDtoCrudServiceImpl.class);
